...
export class BlogComponent implements OnInit {
  ...
  onBlogSubmit() {
    ...
    this.dbService.post('blogs/newBlog', blog).subscribe(data => {
  ...
  getAllBlogs() {
    ...
    this.dbService.get( 'blogs/allBlogs').subscribe(data => {
  ...
  likeBlog(id) {
    ...
    this.dbService.put('blogs/likeBlog/', {id:id}).subscribe(data => {
  ...
  dislikeBlog(id) {
    ...
    this.dbService.put('blogs/dislikeBlog/',{id:id}).subscribe(data => {
  ...
  postComment(id) {
    ...
    this.dbService.post('blogs/comment',{id: id,comment: comment}).subscribe(data => {
  ...
  ngOnInit() {
    ...
    this.dbService.get('users/profile').subscribe((res)=>{
  		console.log(res)
